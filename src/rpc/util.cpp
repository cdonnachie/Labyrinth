...
const std::string EXAMPLE_ADDRESS[2] = {"xb1qc5lj82fls6zd4tsu5tsr7zfyrlxmucmxpsdrvn", "xb1ql6v34pgk2gngvyq373gr0nrv4vnner345729lr"};
...
{
    return "> labyrinth-cli " + methodname + " " + args + "\n";
}
