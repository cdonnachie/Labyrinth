...
UniValue blockheaderToJSON(const CBlockIndex* tip, const CBlockIndex* blockindex)
{
    ...
    result.pushKV("mixhash", blockindex->mix_hash.GetHex());
...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* tip, const CBlockIndex* blockindex, bool txDetails)
{
    ...
    result.pushKV("hash", blockindex->GetBlockHash().GetHex());
    result.pushKV("mixhash", blockindex->mix_hash.GetHex());
    result.pushKV("headerhash", block.GetHeaderHash().GetHex());
    const CBlockIndex* pnext;
    int confirmations = ComputeNextBlockAndDepth(tip, blockindex, pnext);
    result.pushKV("confirmations", confirmations);
...
static RPCHelpMan waitforblock()
{
    return RPCHelpMan{"waitforblock",
                ...
                RPCExamples{
                    HelpExampleCli("waitforblock", "\"0x000062b7fd1f5e3be4b3fd39aa9209ea88c47df6668d19e41ddbaf7f0acfa63e\" 1000")
            + HelpExampleRpc("waitforblock", "\"0x000062b7fd1f5e3be4b3fd39aa9209ea88c47df6668d19e41ddbaf7f0acfa63e\", 1000")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    int timeout = 0;
...
static RPCHelpMan getblockheader()
{
    return RPCHelpMan{"getblockheader",
                ...
                },
                {
                    RPCResult{"for verbose = true",
                        RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {RPCResult::Type::STR_HEX, "mixhash", "the block mix hash"},
                ...
                RPCExamples{
                    HelpExampleCli("getblockheader", "\"0x000062b7fd1f5e3be4b3fd39aa9209ea88c47df6668d19e41ddbaf7f0acfa63e\"")
            + HelpExampleRpc("getblockheader", "\"0x000062b7fd1f5e3be4b3fd39aa9209ea88c47df6668d19e41ddbaf7f0acfa63e\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
...
static RPCHelpMan getblock()
{
    return RPCHelpMan{"getblock",
                ...
                RPCResult::Type::OBJ, "", "",
                {
                    {RPCResult::Type::STR_HEX, "hash", "the block hash (same as provided)"},
                    {RPCResult::Type::STR_HEX, "mixhash", "the block mix hash"},
                    {RPCResult::Type::STR_HEX, "headerhash", "the block header hash"},
                    {RPCResult::Type::NUM, "confirmations", "The number of confirmations, or -1 if the block is not on the main chain"},
                ...
                RPCExamples{
                    HelpExampleCli("getblock", "\"0x000062b7fd1f5e3be4b3fd39aa9209ea88c47df6668d19e41ddbaf7f0acfa63e\"")
            + HelpExampleRpc("getblock", "\"0x000062b7fd1f5e3be4b3fd39aa9209ea88c47df6668d19e41ddbaf7f0acfa63e\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    uint256 hash(ParseHashV(request.params[0], "blockhash"));
                        ...
                        {RPCResult::Type::OBJ, "scriptPubKey", "",
                            {
                                ...
                                {RPCResult::Type::ARR, "addresses", "array of labyrinth addresses",
                                    {{RPCResult::Type::STR, "address", "labyrinth address"}}},
                            }},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    BuriedForkDescPushBack(softforks, "bip34", consensusParams.BIP34Enabled);
    BuriedForkDescPushBack(softforks, "bip65", consensusParams.BIP65Enabled);
    BuriedForkDescPushBack(softforks, "bip66", consensusParams.BIP66Enabled);
    BuriedForkDescPushBack(softforks, "csv", consensusParams.CSVEnabled);
    BuriedForkDescPushBack(softforks, "segwit", consensusParams.SegwitEnabled);
    BuriedForkDescPushBack(softforks, "taproot", consensusParams.TaprootEnabled);
...
static RPCHelpMan getblockstats()
{
    return RPCHelpMan{"getblockstats",
            ...
            RPCResult::Type::OBJ, "", "",
            {
                ...
                RPCExamples{
                    HelpExampleCli("getblockstats", R"('"0x000062b7fd1f5e3be4b3fd39aa9209ea88c47df6668d19e41ddbaf7f0acfa63e"' '["minfeerate","avgfeerate"]')") +
                    HelpExampleCli("getblockstats", R"(1000 '["minfeerate","avgfeerate"]')") +
                    HelpExampleRpc("getblockstats", R"("0x000062b7fd1f5e3be4b3fd39aa9209ea88c47df6668d19e41ddbaf7f0acfa63e", ["minfeerate","avgfeerate"])") +
...
static RPCHelpMan getblockfilter()
{
    return RPCHelpMan{"getblockfilter",
                ...
                RPCExamples{
                    HelpExampleCli("getblockfilter", "\"0x000062b7fd1f5e3be4b3fd39aa9209ea88c47df6668d19e41ddbaf7f0acfa63e\" \"basic\"") +
                    HelpExampleRpc("getblockfilter", "\"0x000062b7fd1f5e3be4b3fd39aa9209ea88c47df6668d19e41ddbaf7f0acfa63e\", \"basic\"")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
...

    {
        ...
        //
        // See discussion here:
        //   https://github.com/labyrinth/labyrinth/pull/15606#discussion_r274479369
        //
        LOCK(::cs_main);
