...
static UniValue GetNetworkHashPS(int lookup, int height) {
    ...
    // If lookup is -1, then use blocks from the difficulty retarget window.
    if (lookup <= 0)
        lookup = pb->nHeight % Params().GetConsensus().nPowDifficultyBlocks + 1;
...
static bool GenerateBlock(ChainstateManager& chainman, CBlock& block, uint64_t& max_tries, unsigned int& extra_nonce, uint256& block_hash)
{
    ...
    uint256 mix_hash;
    while (max_tries > 0 && block.nNonce < std::numeric_limits<uint64_t>::max() && !CheckProofOfWork(block.GetHash(mix_hash), block.nBits, chainparams.GetConsensus()) && !ShutdownRequested()) {
        ++block.nNonce;
        --max_tries;
    }
...
static RPCHelpMan generatetodescriptor()
{
    return RPCHelpMan{
        ...
        "\nMine blocks immediately to a specified descriptor (before the RPC call returns)\n",
        {
            ...
            {"descriptor", RPCArg::Type::STR, RPCArg::Optional::NO, "The descriptor to send the newly generated labyrinth to."},
...
static RPCHelpMan generatetoaddress()
{
    return RPCHelpMan{"generatetoaddress",
                "\nMine blocks immediately to a specified address (before the RPC call returns)\n",
                {
                    ...
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated labyrinth to."},
                    {"maxtries", RPCArg::Type::NUM, /* default */ ToString(DEFAULT_MAX_TRIES), "How many iterations to try."},
                },
                RPCResult{
                    RPCResult::Type::ARR, "", "hashes of blocks generated",
            ...
            + "If you are using the " PACKAGE_NAME " wallet, you can get a new address to send the newly generated labyrinth to with:\n"
...
static RPCHelpMan generateblock()
{
    return RPCHelpMan{"generateblock",
        ...
        {
            {"output", RPCArg::Type::STR, RPCArg::Optional::NO, "The address or descriptor to send the newly generated labyrinth to."},
...
// NOTE: Unlike wallet RPC (which use LAB values), mining RPCs follow GBT (BIP 22) in using satoshi amounts
...
static RPCHelpMan getblocktemplate()
{
    return RPCHelpMan{"getblocktemplate",
                ...
                "    https://github.com/labyrinth/bips/blob/master/bip-0022.mediawiki\n"
                "    https://github.com/labyrinth/bips/blob/master/bip-0023.mediawiki\n"
                "    https://github.com/labyrinth/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
                "    https://github.com/labyrinth/bips/blob/master/bip-0145.mediawiki\n",
                {
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::OBJ_DYN, "foundervalue", "founder details object (if enabled)",
                        {
                            {RPCResult::Type::STR_HEX, "script", "founder script, to be used directly when assembling the founder output"},
                            {RPCResult::Type::NUM, "value", "minimum allowable input for the founder transaction (in satoshis)"},
                        }},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    const bool fPreSegWit = !consensusParams.SegwitEnabled;
    ...
    UniValue foundationObj(UniValue::VOBJ);
        foundationObj.pushKV("script", HexStr(GetFounderScript()));
        foundationObj.pushKV("value", GetFounderAmount());
    result.pushKV("foundervalue", foundationObj);
...
static RPCHelpMan submitblock()
{
    ...
    return RPCHelpMan{"submitblock",
                ...
                "See https://en.labyrinth.it/wiki/BIP_0022 for full specification.\n",
                {
