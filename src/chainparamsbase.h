...
#ifndef LABYRINTH_CHAINPARAMSBASE_H
#define LABYRINTH_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between labyrinth-cli and labyrinthd)
 * of a given instance of the Labyrinth system.
 */
...
#endif // LABYRINTH_CHAINPARAMSBASE_H
