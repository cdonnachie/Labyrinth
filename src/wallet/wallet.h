...
#ifndef LABYRINTH_WALLET_WALLET_H
#define LABYRINTH_WALLET_WALLET_H
...
public:
     ...
     * on this labyrinth node, and set to 0 for transactions that were created
...
#endif // LABYRINTH_WALLET_WALLET_H
