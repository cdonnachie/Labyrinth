...
#ifndef LABYRINTH_WALLET_SCRIPTPUBKEYMAN_H
#define LABYRINTH_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Labyrinth Core wallet was originally a collection of unrelated private
...
#endif // LABYRINTH_WALLET_SCRIPTPUBKEYMAN_H
