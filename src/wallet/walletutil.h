...
#ifndef LABYRINTH_WALLET_WALLETUTIL_H
#define LABYRINTH_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! labyrinth from opening the wallet, thinking it was newly created, and
...
#endif // LABYRINTH_WALLET_WALLETUTIL_H
