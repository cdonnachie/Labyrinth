...
#ifndef LABYRINTH_COMPAT_ASSUMPTIONS_H
#define LABYRINTH_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Labyrinth cannot be compiled without assertions."
#endif
...
#endif // LABYRINTH_COMPAT_ASSUMPTIONS_H
