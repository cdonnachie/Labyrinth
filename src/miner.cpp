...
std::unique_ptr<CBlockTemplate> BlockAssembler::CreateNewBlock(const CScript& scriptPubKeyIn)
{
    ...
    fIncludeWitness = chainparams.GetConsensus().SegwitEnabled;
    ...
    CScript founderScript = GetFounderScript();
    CAmount founderAmount = GetFounderAmount();

    coinbaseTx.vout.resize(2);
    coinbaseTx.vout[0].scriptPubKey = scriptPubKeyIn;
    coinbaseTx.vout[0].nValue = (nFees + GetBlockSubsidy(nHeight, chainparams.GetConsensus())) - founderAmount;
        
    coinbaseTx.vout[1].scriptPubKey = founderScript;
    coinbaseTx.vout[1].nValue = founderAmount;
