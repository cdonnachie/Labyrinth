...
#ifndef LABYRINTH_SCRIPT_SCRIPT_H
#define LABYRINTH_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Labyrinth always counted CHECKMULTISIGs
...
#endif // LABYRINTH_SCRIPT_SCRIPT_H
