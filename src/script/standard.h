...
#ifndef LABYRINTH_SCRIPT_STANDARD_H
#define LABYRINTH_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a labyrinth address
 */
...
/**
 * Generate a Labyrinth scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // LABYRINTH_SCRIPT_STANDARD_H
