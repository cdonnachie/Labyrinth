...
#ifndef LABYRINTH_QT_GUIUTIL_H
#define LABYRINTH_QT_GUIUTIL_H
...
/** Utility functions used by the Labyrinth Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "labyrinth:" URI into recipient object, return true on successful parsing
