...
//! Entry point for LabyrinthApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &LabyrinthApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for LabyrinthGUI tests.
void AppTests::guiTests(LabyrinthGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &LabyrinthGUI::consoleShown, this, &AppTests::consoleTests);
