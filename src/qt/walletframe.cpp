...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, LabyrinthGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &LabyrinthGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &LabyrinthGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &LabyrinthGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &LabyrinthGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &LabyrinthGUI::updateWalletStatus);
    connect(gui, &LabyrinthGUI::setPrivacy, walletView, &WalletView::setPrivacy);
