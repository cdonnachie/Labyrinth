    ...
    platformStyle(_platformStyle)
{
    ...
    // normal labyrinth address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying labyrinth address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &LabyrinthAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
