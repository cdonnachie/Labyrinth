    ...
    mapper(nullptr)
{
    ...
    ui->labyrinthAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->labyrinthAtStartup);
    ...
    ui->labyrinthAtStartup->setToolTip(ui->labyrinthAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->labyrinthAtStartup->setText(ui->labyrinthAtStartup->text().arg(PACKAGE_NAME));

    ui->openLabyrinthConfButton->setToolTip(ui->openLabyrinthConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new LabyrinthUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->labyrinthAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openLabyrinthConfButton_clicked()
{
