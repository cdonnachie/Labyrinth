...
static void SetupLabyrinthTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " labyrinth-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  labyrinth-tx [options] <hex-tx> [commands]  Update hex-encoded labyrinth transaction\n" +
            "or:     labyrinth-tx [options] -create [commands]   Create hex-encoded labyrinth transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded labyrinth transaction
