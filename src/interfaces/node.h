...
#ifndef LABYRINTH_INTERFACES_NODE_H
#define LABYRINTH_INTERFACES_NODE_H
...
//! Top-level interface for a labyrinth node (labyrinthd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // LABYRINTH_INTERFACES_NODE_H
