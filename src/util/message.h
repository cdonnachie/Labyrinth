...
#ifndef LABYRINTH_UTIL_MESSAGE_H
#define LABYRINTH_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's labyrinth address, it must refer to a public key.
...
#endif // LABYRINTH_UTIL_MESSAGE_H
