 ...
 */
#ifndef LABYRINTH_UTIL_SYSTEM_H
#define LABYRINTH_UTIL_SYSTEM_H
...
extern const char * const LABYRINTH_CONF_FILENAME;
extern const char * const LABYRINTH_SETTINGS_FILENAME;
