 ...
 * for both labyrinthd and labyrinth-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Labyrinth");
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/labyrinth/bips/blob/master/bip-0014.mediawiki)
 */
