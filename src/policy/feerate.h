...
#ifndef LABYRINTH_POLICY_FEERATE_H
#define LABYRINTH_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "LAB"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    LAB_KVB,      //!< Use LAB/kvB fee rate unit
...
public:
     ...
     *  where 1e5 is the ratio to convert from LAB/kvB to sat/vB.
     *
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::LAB_KVB) const;

    SERIALIZE_METHODS(CFeeRate, obj) { READWRITE(obj.nSatoshisPerK); }
};

#endif //  LABYRINTH_POLICY_FEERATE_H
