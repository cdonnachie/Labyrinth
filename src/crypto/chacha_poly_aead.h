...
#ifndef LABYRINTH_CRYPTO_CHACHA_POLY_AEAD_H
#define LABYRINTH_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@labyrinth.
 *
 ...
 *
 * The chacha20-poly1305@labyrinth combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@labyrinth cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@labyrinth are relatively fast in
...
#endif // LABYRINTH_CRYPTO_CHACHA_POLY_AEAD_H
