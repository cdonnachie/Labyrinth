...
static const unsigned char ParseHex_expected[65] = {
    0x3a, 0x64, 0xb2, 0x00, 0x57, 0x45, 0xe9, 0x45, 0x8b, 0xd4,
    0xa9, 0xda, 0x51, 0x91, 0xbc, 0xcc, 0x88, 0x49, 0xdd, 0x05,
    0x0f, 0xe3, 0xd5, 0xd7, 0x67, 0xd7, 0x14, 0x16, 0xd0, 0x94,
    0x6a, 0x9b, 0x07, 0xe4, 0x86, 0xaa, 0xcc, 0xdc, 0x7d, 0xdf,
    0x3f, 0x23, 0xc9, 0x34, 0x90, 0x7a, 0xf4, 0x73, 0x2b, 0x9a,
    0xd4, 0xd0, 0x07, 0x4a, 0x4d, 0x50, 0x18, 0xe4, 0x57, 0xcb,
    0xfe, 0xb2, 0xb3, 0x63, 0xda
};
BOOST_AUTO_TEST_CASE(util_ParseHex)
{
    ...
    // Basic test vector
    result = ParseHex("3a64b2005745e9458bd4a9da5191bccc8849dd050fe3d5d767d71416d0946a9b07e486aaccdc7ddf3f23c934907af4732b9ad4d0074a4d5018e457cbfeb2b363da");
...
BOOST_AUTO_TEST_CASE(util_HexStr)
{
    BOOST_CHECK_EQUAL(
        ...
        "3a64b2005745e9458bd4a9da5191bccc8849dd050fe3d5d767d71416d0946a9b07e486aaccdc7ddf3f23c934907af4732b9ad4d0074a4d5018e457cbfeb2b363da");
...
BOOST_FIXTURE_TEST_CASE(util_ArgsMerge, ArgsMergeTestingSetup)
{
    ...
    //
    //   ARGS_MERGE_TEST_OUT=results.txt ./test_labyrinth --run_test=util_tests/util_ArgsMerge
    //
...
BOOST_FIXTURE_TEST_CASE(util_ChainMerge, ChainMergeTestingSetup)
{
    ...
    // If check below fails, should manually dump the results with:
    //
    //   CHAIN_MERGE_TEST_OUT=results.txt ./test_labyrinth --run_test=util_tests/util_ChainMerge
    //
    // And verify diff against previous results to make sure the changes are expected.
    //
    // Results file is formatted like:
...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("labyrinth"), "Labyrinth");
...
BOOST_AUTO_TEST_CASE(message_sign)
{
    const std::array<unsigned char, 32> privkey_bytes = {
        // Address: XjgERbqyrNDxeswioTmUX7Vat5pXHvL1sJ
        // WIF: L1oDtLQ7QKpZCpPhgYi5PATX49CnTW1enpTSohxxjc3u7oHybZqF
        0x88, 0x96, 0xE7, 0xE0, 0x12, 0x3A, 0x68, 0x51,
        0xC4, 0xD3, 0xE5, 0xC8, 0xAE, 0x05, 0xF4, 0xCE,
        0x2F, 0x29, 0x9C, 0x55, 0x78, 0x0E, 0x8D, 0x54,
        0x2D, 0x4D, 0x93, 0xA7, 0xE5, 0x5C, 0x01, 0xAA
    };

    const std::string message = "Trust no one";

    const std::string expected_signature =
        "IO/8DJMO9DqDD3czCzlFOoyTx3b6sL6NMVlZ+4qNns+4NgXStsjkoIeTZ6SSQtqUJal1vSwH6lFhB6bu8pQ5chc=";
...
BOOST_AUTO_TEST_CASE(message_verify)
{
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "BgNCWvY7uPF6xLGo2BjqQ3oBuAHpCH4HVt",
            "signature should be irrelevant",
            "message too"),
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "XjgERbqyrNDxeswioTmUX7Vat5pXHvL1sJ",
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "XjgERbqyrNDxeswioTmUX7Vat5pXHvL1sJ",
            "IDodEWjXdP/gTkxntPtxKd0s5s6amPR7aAbjotVQg7LrekPwnodUtmZZBbpX216X9hmnu2a9is9NN4uUmLAoCqg=",
            "I never signed this"),
    ...
    BOOST_CHECK_EQUAL(
        MessageVerify(
            "XjgERbqyrNDxeswioTmUX7Vat5pXHvL1sJ",
            "H0nwuu+2ZwDpYV9jRkHEbhd4yb83Bvf4ix9t6WQz72fdBLa93pk7M5IuHH3wmf7si6MAq/6cfPohqCp1wCZwyww=",
            "Trust me"),
        MessageVerificationResult::OK);
}
