...
#include <crypto/kawpow/helpers.hpp>
#include <crypto/kawpow/progpow_test_vectors.hpp>
...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As Labyrinth relies on 80 byte header hashes, we want to have an example for that.",
               "ff51a0ecf5118d916734083ccd4feae1920d5568ffe15e8d185d773eb2d683f3");
...
{
    /* test chacha20poly1305@labyrinth AEAD */
...
BOOST_AUTO_TEST_CASE(kawpow_search)
{
    ...
    BOOST_CHECK(sr.mix_hash == kawpow::hash256{});
    BOOST_CHECK(sr.final_hash == kawpow::hash256{});
