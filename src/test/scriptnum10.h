...
#ifndef LABYRINTH_TEST_SCRIPTNUM10_H
#define LABYRINTH_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Labyrinth Core 0.10.0, for cross-comparison.
 */
public:
