...
class TestShell:
    """Wrapper Class for LabyrinthTestFramework.

    The TestShell class extends the LabyrinthTestFramework
    ...
    class __TestShell(LabyrinthTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by LabyrinthTestFramework child class.
            self.num_nodes = 1
