...
class P2PPermissionsTests(LabyrinthTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].labyrinthconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].labyrinthconf, 'w', encoding="utf8") as f:
            f.write(newText)
