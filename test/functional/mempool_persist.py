...
By default, labyrinthd will dump mempool on shutdown and
...
class MempoolPersistTest(LabyrinthTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent labyrinthd from writing mempool.dat to disk. Verify that `savemempool` fails")
