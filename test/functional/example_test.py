...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the LabyrinthTestFramework
    pass


class ExampleTest(LabyrinthTestFramework):
    # Each functional test is a subclass of the LabyrinthTestFramework class.
    ...
    def custom_method(self):
        ...
        LabyrinthTestFramework class so other tests can use it."""
