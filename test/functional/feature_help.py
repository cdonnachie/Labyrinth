...
"""Verify that starting labyrinth with -h works as expected."""

from test_framework.test_framework import LabyrinthTestFramework
from test_framework.util import assert_equal

class HelpTest(LabyrinthTestFramework):
    ...
    def run_test(self):
        self.log.info("Start labyrinth with -h for help text")
        ...
        self.log.info("Start labyrinth with -version for version information")
        ...
        self.log.info("Start labyrinthd with -fakearg to make sure it does not start")
