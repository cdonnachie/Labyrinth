...
Labyrinth Core is released under the terms of the MIT license. See [COPYING](COPYING) for more
...
completely stable. [Tags](https://github.com/labyrinth/labyrinth/tags) are created
regularly from release branches to indicate new official, stable release versions of Labyrinth Core.

The https://github.com/labyrinth-core/gui repository is used exclusively for the
