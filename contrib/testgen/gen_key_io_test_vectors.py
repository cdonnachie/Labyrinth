...
bech32_templates = [
  ...
  ('xb',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('xb',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('xb',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('xb',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tn',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tn',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tn',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tn',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('rs',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rs',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rs',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rs', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, encoding, invalid_bech32, invalid_checksum, invalid_char
  ('tn',    0, 20, Encoding.BECH32,  False, False, False),
  ('xt',    1, 32, Encoding.BECH32M, False, False, False),
  ('tn',   17, 32, Encoding.BECH32M, False, False, False),
  ('rs',  3,  1, Encoding.BECH32M, False, False, False),
  ('xb',   15, 41, Encoding.BECH32M, False, False, False),
  ('tn',    0, 16, Encoding.BECH32,  False, False, False),
  ('rs',  0, 32, Encoding.BECH32,  True,  False, False),
  ('xb',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tn',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rs',  0, 20, Encoding.BECH32,  False, False, True),
  ('xb',    0, 20, Encoding.BECH32M, False, False, False),
  ('tn',    0, 32, Encoding.BECH32M, False, False, False),
  ('rs',  0, 20, Encoding.BECH32M, False, False, False),
  ('xb',    1, 32, Encoding.BECH32,  False, False, False),
  ('tn',    2, 16, Encoding.BECH32,  False, False, False),
  ('rs', 16, 20, Encoding.BECH32,  False, False, False),
]
