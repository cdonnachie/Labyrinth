...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the labyrinth repository."
  exit 1
fi
...
# See https://github.com/labyrinth/labyrinth/issues/16064
...
echo 'When compiling labyrinthd, run `./configure` in the following way:'
echo
