...
Arguments:
    <base_directory> - The base directory of a labyrinth source code repository.
...
Arguments:
    <file> - A source file in the labyrinth repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Labyrinth
