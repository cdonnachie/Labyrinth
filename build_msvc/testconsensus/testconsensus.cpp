...
// labyrinth includes.
#include <..\src\script\labyrinthconsensus.h>
...
int main()
{
    std::cout << "labyrinthconsensus version: " << labyrinthconsensus_version() << std::endl;
    ...
    auto op0Result = labyrinthconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, labyrinthconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
