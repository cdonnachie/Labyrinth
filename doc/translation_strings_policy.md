...
This document provides guidelines for internationalization of the Labyrinth Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `labyrinth_en.ts` remains unchanged.
